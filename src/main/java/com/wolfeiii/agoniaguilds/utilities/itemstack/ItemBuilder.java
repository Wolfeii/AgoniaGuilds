...
public class ItemBuilder {
    ...
    public ItemBuilder asSkullOf(GuildUser guildUser) {
        if (itemStack.getType() == Material.PLAYER_HEAD)
            textureValue = guildUser == null ? ItemSkulls.getNullPlayerTexture() : guildUser.getTextureValue();
        return this;
    }
    ...
    public ItemBuilder withEntityType(EntityType entityType) {
        ...
        if (!itemStack.getType().isBlock() && itemStack.getType().name().contains(ServerVersion.isLegacy() ? "MONSTER_EGG" : "SPAWN_EGG")) {
    ...
    public ItemStack build(GuildUser guildUser) {
        OfflinePlayer offlinePlayer = guildUser.asOfflinePlayer();
        ...
        if (textureValue.equals("%guild_player_texture%"))
            textureValue = guildUser.getTextureValue();
