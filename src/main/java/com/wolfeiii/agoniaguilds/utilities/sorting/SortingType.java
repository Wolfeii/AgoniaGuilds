...
public class SortingType implements Comparator<Guild>, Enumerable {

    private static final Map<String, SortingType> sortingTypes = new HashMap<>();
    private static int ordinalCounter = 0;

    private static final Comparator<Guild> ISLAND_NAMES_COMPARATOR = (o1, o2) -> {
    ...
    private SortingType(String name, Comparator<Guild> comparator, boolean handleEqualsIslands) {
        this.name = name;
     ...
     * @param comparator The comparator for sorting the guilds.
     */
    public static void register(String name, Comparator<Guild> comparator) {
     ...
     * @param name                The name for the sorting type.
     * @param comparator          The comparator for sorting the guilds.
     * @param handleEqualsIslands Should the plugin handle equals guilds?
     *                            If that's false, you should handle it on your own.
     */
    public static void register(String name, Comparator<Guild> comparator, boolean handleEqualsIslands) {
        Preconditions.checkNotNull(name, "name parameter cannot be null.");
        Preconditions.checkNotNull(comparator, "comparator parameter cannot be null.");
        ...
        AgoniaGuilds.getAgoniaGuilds().getGuildManager().addSortingType(sortingType, true);
    }
     ...
     */
    public Comparator<Guild> getComparator() {
        return comparator;
    }
