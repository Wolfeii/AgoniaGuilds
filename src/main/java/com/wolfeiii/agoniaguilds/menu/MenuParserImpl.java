...
import com.wolfeiii.agoniaguilds.menu.button.impl.BackButton;
import com.wolfeiii.agoniaguilds.menu.button.impl.DummyButton;
import com.wolfeiii.agoniaguilds.menu.interfaces.parser.MenuParseException;
...
import com.wolfeiii.agoniaguilds.utilities.io.Resources;
...
public class MenuParserImpl implements MenuParser {
    ...
    public <V extends PagedMenuView<V, ?, E>, E> MenuParseResult<V> parseMenu(
        ...
        if (plugin.getConfiguration().isOnlyBackButton() && !backButtonFound) {
    ...
    public interface IMenuConverter {
        ...
        boolean convert(AgoniaGuilds plugin, YamlConfiguration cfg);
