...
public abstract class RemoteSQLSession implements SQLSession {
    ...
    protected final AgoniaGuilds plugin;

    @Nullable
    protected HikariDataSource dataSource;
    protected boolean logging;

    protected RemoteSQLSession(AgoniaGuilds plugin, boolean logging) {
        this.plugin = plugin;
        setLogging(logging);
    }
    ...
    public void createTable(String tableName, Pair<String, String>[] columns, QueryResult<Void> queryResult) {
        ...
        String prefix = plugin.getConfiguration().getDatabaseSection().getPrefix();
