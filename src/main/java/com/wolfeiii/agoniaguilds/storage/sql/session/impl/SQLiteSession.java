...
public class SQLiteSession implements SQLSession {
    ...
    public SQLiteSession(AgoniaGuilds plugin, boolean logging) {
        this.plugin = plugin;
    ...
    public boolean createConnection() {
        ...
        try {
            ...
            Log.error(error, "Ett oförväntat fel uppstod vid anslutningen till SQLite databasen:");
        }
    ...
    public void closeConnection() {
        Preconditions.checkNotNull(this.conn, "Sessionen skapades inte.");

        try {
            conn.close();
        } catch (SQLException error) {
            Log.error(error, "Ett oförväntat fel uppstod vid avslutning av anslutningen till SQLite databasen:");
        }
    }
    ...
    public void waitForConnection() {
        try {
            ...
            Log.error(error, "Ett oförväntat fel uppstod vid väntning av anslutningen.");
        }
    }
